...
with app.app_context():
    ...
    # Initial loading of users, adding myself as a student
    users = [
        ...
        {'username': 'jkorba1', 'email': 'jkorba1@umd.edu', 'first_name': 'Jacob', 'last_name': 'Korba',
         'password': generate_password_hash('manasandbonoarecoolbeans', method='pbkdf2:sha256'), 'role': 'STUDENT'}
    ]
